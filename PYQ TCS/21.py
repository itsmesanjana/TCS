...
# Dividing the string into sets of 3 characters each Set 1: {b,b,b}
# Set 2: {a,a,a}
# Set 3: {b,a,b}
...
def max_aqua_count(s,L):
    max_a_count=0
    
    for i in range(0,len(s),L):
        substring=s[i:i+L]
        max_a_count=max(max_a_count,substring.count('a'))
    return max_a_count

s=input().strip()
L=int(input().strip())

print(max_aqua_count(s,L))
